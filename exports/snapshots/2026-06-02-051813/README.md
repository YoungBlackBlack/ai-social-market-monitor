...
7. `scripts/export-standalone-html.mjs`
8. `scripts/validate-brief.mjs`
9. `scripts/validate-frontend.mjs`
10. `scripts/validate-deliverable.mjs`
11. `scripts/snapshot-current.mjs`
