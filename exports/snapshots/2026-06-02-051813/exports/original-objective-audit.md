...
- IRL/线下真人证据地图：26 行。
- Monitor：9 条 lane、31 条近窗信号、1 条新增提醒；待复核为 0。
...
- 状态：proved-for-current-evidence-with-monitor-boundary
- 证据：IRL/线下真人覆盖 26 个唯一条目，主表 IRL 样本 14 个；线下真人证据地图 26 行，其中融资/新闻链接 19 行、monitor 链接 9 行、强证据 5 行。
...
- 证据：当前 Exa Websets Monitor 权限不可用，使用 Search API + Codex automation fallback；最近 monitor 9 条 lane、31 条近窗高相关信号、1 条新增提醒；latest alert 待复核 0，recent signal 待复核 0。
