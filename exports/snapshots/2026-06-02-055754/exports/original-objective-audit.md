...
- IRL/线下真人证据地图：27 行。
- Monitor：9 条 lane、33 条近窗信号、1 条新增提醒；待复核为 0。
...
- 证据：当前 Exa Websets Monitor 权限不可用，使用 Search API + Codex automation fallback；最近 monitor 9 条 lane、33 条近窗高相关信号、1 条新增提醒；latest alert 待复核 0，recent signal 待复核 0。
