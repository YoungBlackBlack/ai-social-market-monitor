...
| monitor_signals | 33 | 最近一次 Exa monitor 近窗信号。 |
| source_linkage | 746 | Exa 原始/补充来源的 linked、候选、背景、低相关分流状态。 |
| coverage_gaps | 55 | 未关联来源按复核层级分组后的覆盖缺口 Register。 |
...
| view_latest_monitor_signals | 33 | 最近一次 monitor 信号视图。 |
| view_unresolved_coverage_gaps | 39 | 仍有 unresolved_count 的覆盖缺口视图。 |
