...
Generated: 2026-06-06 09:06 CST
...
| `#monitor` | 持续监控 | Loaded; daily Exa monitor digest visible with 9 lanes, 34 recent items, 0 new alerts |
...
- Latest alert review: 69 rows, pending 0
- Recent signal review: 34 rows, pending 0
- Latest handled alert: `WTMF AI`
- Latest decision: `边界观察`
