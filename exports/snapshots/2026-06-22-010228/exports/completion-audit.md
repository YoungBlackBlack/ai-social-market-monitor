...
Generated from current workspace data at 2026-06-22T01:02:28.419Z.
...
- Language official evidence map: 16 curated language products, 4 ready, 10 displayable, 2 thin.
...
- IRL coverage audit: 24 unique offline-human/IRL entries, 8 core, 4 monitor-linked.
- IRL offline evidence map: 24 entries, 17 funding/news-linked, 4 monitor-linked, 1 strong.
...
- Paid acquisition evidence audit: 42 products, 0 explicit paid-acquisition rows, 37 directional channel rows, 5 no-paid-evidence rows, 4 monitor paid-acquisition signals.
...
- Monitor: 9 lanes, 15 recent high-signal items, 2 new alerts in latest run; recent signal review queue: 15.
...
Codex automation 每日 09:00 运行 Exa monitor；monitor 当前 9 条 lane，历史运行 30 次，台账保留 176 条已发现 URL，最新新增 2 条。
