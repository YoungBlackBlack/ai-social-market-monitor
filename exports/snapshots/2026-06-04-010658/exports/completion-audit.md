...
Generated from current workspace data at 2026-06-04T01:05:38.047Z.
...
- IRL coverage audit: 26 unique offline-human/IRL entries, 8 core, 9 monitor-linked.
- IRL offline evidence map: 26 entries, 20 funding/news-linked, 11 monitor-linked, 6 strong.
...
- Paid acquisition evidence audit: 42 products, 0 explicit paid-acquisition rows, 37 directional channel rows, 5 no-paid-evidence rows, 8 monitor paid-acquisition signals.
...
- Monitor: 9 lanes, 34 recent high-signal items, 9 new alerts in latest run; recent signal review queue: 34.
...
Codex automation 每日 09:00 运行 Exa monitor；monitor 当前 9 条 lane，历史运行 30 次，台账保留 56 条已发现 URL，最新新增 9 条。
