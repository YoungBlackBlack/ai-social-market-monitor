...
- IRL/线下真人证据地图：27 行，其中 monitor 链接 10 行。
- Exa 查询：60 组，646 条结果。
- Monitor：9 条 lane，33 条近窗信号，1 条新增提醒；历史运行 30 次，提醒台账 37 条，连续 0 次无新增提醒。
- 待复核：latest alert 0，recent signal 0。
- 投放/付费获客：产品级明确投放 0，方向性渠道 37，无投放证据 5；可声称付费投放 0，只能声称渠道线索 37，不能声称投放 5；monitor 候选 6，本轮新增 1。
- 原始目标逐条审计：9 行。

## 展示入口

- localWeb: `http://localhost:8001/#home`
