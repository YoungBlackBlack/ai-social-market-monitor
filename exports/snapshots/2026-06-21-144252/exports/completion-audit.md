...
Generated from current workspace data at 2026-06-21T14:42:51.640Z.
...
- Exa query matrix: 60 searches / 625 raw results.
- Categories covered: official/social profile: 24 queries / 256 results; company: 17 queries / 160 results; news: 11 queries / 125 results; financial report: 4 queries / 36 results; people: 2 queries / 24 results; research paper: 2 queries / 24 results.
- Product evidence cards: 42; language-exchange adjacent: 16; IRL/offline social: 14.
- Raw source linkage audit: 723 results, 611 linked to curated products/timeline/official evidence, 112 in review queue.
- Language coverage audit: 20 unique HelloTalk/Tandem-adjacent entries, 16 in core matrix, 1 in watchlist.
- Language official evidence map: 16 curated language products, 8 ready, 5 displayable, 3 thin.
- Language official/social deep-dive: 14 targeted Exa searches, 111 results.
- Language growth/channel deep-dive: 12 targeted Exa searches, 96 results, 3 strong and 9 usable product rows.
- IRL coverage audit: 25 unique offline-human/IRL entries, 8 core, 5 monitor-linked.
- IRL offline evidence map: 25 entries, 17 funding/news-linked, 5 monitor-linked, 1 strong.
- Candidate deep dive: 11 product candidates, 22 targeted Exa company/news searches, 132 results.
- Funding/news timeline: 25 core events plus 12 supplemental candidates from exact window 2024-06-02 - 2026-06-02 / month window 2024.06 - 2026.06; IRL events: 9; explicit USD funding total: $200M.
- Funding/news dedupe: 37 raw review rows, 34 unique events, 3 duplicate rows.
- Funding upgrade map: 12 supplemental rows, 9 retained candidates, 3 duplicate evidence rows, 4 retained IRL candidates.
- Discovery scan: 10 blind-spot scans / 98 supplementary results.
- Paid acquisition evidence audit: 42 products, 0 explicit paid-acquisition rows, 37 directional channel rows, 5 no-paid-evidence rows, 2 monitor paid-acquisition signals.
- Coverage gaps: 112 unmatched rows retained, 25 product-candidate gaps reviewed by candidate deep-dive, 85 still monitored or archived by lane.
- Monitor: 9 lanes, 13 recent high-signal items, 0 new alerts in latest run; recent signal review queue: 13.
...
60 个 Exa 查询、625 条原始结果；主矩阵包含 company、news、research paper、financial report、people，另有 official/social profile pass。
...
2024-06-02 - 2026-06-02 对应月份窗口 2024.06 - 2026.06；主时间线 25 条，另有 discovery supplemental 12 条候选融资/新闻；funding summary 按年份、赛道、IRL 占比、明确美元融资口径统计，产品聚合覆盖 32 个产品/公司。
...
Codex automation 每日 09:00 运行 Exa monitor；monitor 当前 9 条 lane，历史运行 30 次，台账保留 171 条已发现 URL，最新新增 0 条。
...
消费社交产品持续变化，页面用 broad evidence pass + watchlist + monitor 逼近覆盖，但不声称数学穷尽；另有 10 组盲区扫描、98 条补充结果覆盖 AI friend/wearable、AI-native social、AI dating、companion 长尾、IRL 长尾和语言交换长尾。
...
- Monitored signal rows: 22.
- Latest alert pending rows: 28.
