...
Generated from current workspace data at 2026-06-08T09:12:06.220Z.
...
- Raw source linkage audit: 746 results, 623 linked to curated products/timeline/official evidence, 123 in review queue.
- Language coverage audit: 19 unique HelloTalk/Tandem-adjacent entries, 16 in core matrix, 0 in watchlist.
- Language official evidence map: 16 curated language products, 3 ready, 9 displayable, 4 thin.
...
- IRL coverage audit: 29 unique offline-human/IRL entries, 8 core, 11 monitor-linked.
- IRL offline evidence map: 29 entries, 22 funding/news-linked, 14 monitor-linked, 9 strong.
- Candidate deep dive: 12 product candidates, 24 targeted Exa company/news searches, 144 results.
...
- Paid acquisition evidence audit: 42 products, 0 explicit paid-acquisition rows, 37 directional channel rows, 5 no-paid-evidence rows, 7 monitor paid-acquisition signals.
- Coverage gaps: 123 unmatched rows retained, 31 product-candidate gaps reviewed by candidate deep-dive, 89 still monitored or archived by lane.
- Monitor: 9 lanes, 33 recent high-signal items, 0 new alerts in latest run; recent signal review queue: 33.
...
Codex automation 每日 09:00 运行 Exa monitor；monitor 当前 9 条 lane，历史运行 30 次，台账保留 82 条已发现 URL，最新新增 0 条。
