...
- 产品主表：42 个。
- HelloTalk/Tandem 相邻唯一覆盖：21 个，其中主表语言产品 16 个。
- 近两年融资/新闻：主时间线 25 条，补充候选 13 条，合并复核 38 行，去重唯一事件 35 个；窗口外 0 行，重复 3 行，IRL 唯一 14 行，产品聚合 33 行。
- IRL/线下真人证据地图：29 行，其中 monitor 链接 11 行。
- Exa 查询：60 组，646 条结果。
- Monitor：9 条 lane，37 条近窗信号，10 条新增提醒；历史运行 30 次，提醒台账 107 条，连续 0 次无新增提醒。
- 待复核：latest alert 3，recent signal 3。
- 投放/付费获客：产品级明确投放 0，方向性渠道 37，无投放证据 5；可声称付费投放 0，只能声称渠道线索 37，不能声称投放 5；monitor 候选 10，本轮新增 5。
- 原始目标逐条审计：9 行。
